...
int main(){
    ...
    while(1){
        ...
        if(control == 1){
            ...
            if(g1 < 0 || g1 > games[0].get_games_num() ||g2 < 0 || g2 > games[0].get_games_num()){
                ...
                if(games[g1-1].compare_games(games[g2-1]) == true){
                    cout << "First game has more marked cell than second game.\n";
                }
                else{
                    cout << "Second game has more marked cell than first game.\n";
                }
            }
        }
        else if(control == 2){
    ...
    cout << games[0].compare_games(games[1]);
    return 0;
}
