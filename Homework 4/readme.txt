Update Notes:
There was added new command UNDO to menu.You can type UNDO to take back the last move.
There was added new feature which is Score.It display after move is happened. 
There was overloaded == opeartor.It return true if the first game has more marked cell otherwise it return false.
